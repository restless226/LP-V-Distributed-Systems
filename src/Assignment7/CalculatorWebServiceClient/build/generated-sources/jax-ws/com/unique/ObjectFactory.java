...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://unique.com/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://unique.com/", "addResponse");
    private final static QName _Divide_QNAME = new QName("http://unique.com/", "divide");
    private final static QName _DivideResponse_QNAME = new QName("http://unique.com/", "divideResponse");
    private final static QName _Multiply_QNAME = new QName("http://unique.com/", "multiply");
    private final static QName _MultiplyResponse_QNAME = new QName("http://unique.com/", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://unique.com/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://unique.com/", "subtractResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unique.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unique.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unique.com/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unique.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unique.com/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unique.com/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unique.com/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unique.com/", name = "subtractResponse")
